...
def predict_pedocs(target_df, feature_df):
    ...
    feature_series = TimeSeries.from_dataframe(feature_df, time_col='timestamp', freq='h', fill_missing_dates=True)
    ...
    target_series = TimeSeries.from_dataframe(target_df, time_col='timestamp', freq='h', fill_missing_dates=True)
